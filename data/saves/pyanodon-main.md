...
| Tar refinery | middle-oil 60/s, creosote 48/s, gasoline 60/s, coke 15/s, pitch 280/s | 200/s tar in | 8 (tar, water in; 5 outputs + anthracene consumed) | 10 tar-processing (tar-refining), 12 distilator (anthracene-gasoline-cracking), 4 oil-boiler, 1 py-electric-boiler | Anthracene fully cracked to gasoline+coke, self-powered via oil boilers. Currently stalled — all outputs can back up without consumers. Needs overflow-to-void on every output without a steady consumer (pitch 280/s, middle-oil 60/s, coke 15/s, and potentially creosote 48/s and gasoline 60/s if internal boilers saturate). Fix before glass block (needs coke) |
