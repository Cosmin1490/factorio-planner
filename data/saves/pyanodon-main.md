...
| Log | log | 1.5/s | 4 (water, ash, moss in; log out) | 10 fwf-mk01 (log3), 5 botanical-nursery (wood-seedling), 1 assembling-machine-1 (wood-seeds), 1 wpu (log-wood-fast) | 10 fawogae modules each, seedling supply exactly balanced |
